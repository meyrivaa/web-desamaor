            ...
            <div class="umkm-grid" id="umkm-grid">
                ...
                <article class="umkm-card" data-category="{{ strtolower($item['kategori']) }}"
                    ...
                    <div class="umkm-card-image">
                        ...
                        <img src="{{ asset('uploads/' . $item['gambar']) }}" alt="{{ $item['nama_produk'] }}" loading="lazy" decoding="async">
                ...
                <div class="umkm-empty">
                    ...
                    <svg class="umkm-empty-icon" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M6 8h12l1 13H5L6 8Z"></path>
                        <path d="M9 8V6a3 3 0 0 1 6 0v2"></path>
                    </svg>
                    ...
                    <p>
                        Produk UMKM Desa Maor belum tersedia.
                    </p>
